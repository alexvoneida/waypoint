...
import { stravaImportActivity } from "@/lib/jobs/strava-import";
import { trailMatch } from "@/lib/jobs/trail";
import { trailName } from "@/lib/jobs/trail-name";

export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [exifExtract, derive, photoCorrelateCheck, trailMatch, trailName, stravaBackfillList, stravaImportActivity],
});
